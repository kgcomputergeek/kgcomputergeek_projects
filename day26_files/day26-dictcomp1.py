...
"""
checking my comprehension. word is each word which is a key and the length of each word and/or punctuation before whitespace is the value pair which we get from the sentence.split(), which is our string split. 
"""
