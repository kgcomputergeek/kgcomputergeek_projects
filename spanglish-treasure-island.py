...
#TIP: DO NOT USE UPPERCASE IN THE IF STATEMENTS WHICH ARE THE SELECTIONS/CHOICES. IF YOU DO, THE CODE WILL SEE THE UPPERCASE AND IGNORE THE CODE ASSOCIATED WITH THE LOWER FUNCTION
if selection_1 == "left":
