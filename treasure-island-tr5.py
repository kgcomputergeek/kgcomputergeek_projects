...
while level_2 != 'wait':
    ...
    level_3 = ''
    while level_3 != 'yellow':
        level_3 = int(input("It seems you've made it to Cuarto Tres. In this room, there are three doors and two of them are trampas or traps. Choose 'red' , 'blue', or 'yellow' \n"))
        level_3.lower()
    if level_3 == 'red':
