...
direction_selection = input("Please make a selection. left or right?:  \n").lower()

if direction_selection == "Left":
    move_selection = input("Please make a selection. swim or wait?:  \n").lower()
else:
    print("You fell into a hole. Game over =( \n")
if move_selection == "Swim":
    print("You've been attacked by the nasty, trickster trout. GAME OVER =(\n")
else:
    door_selection = input("Please make a selection. Red, blue or yellow door? \n").lower()
