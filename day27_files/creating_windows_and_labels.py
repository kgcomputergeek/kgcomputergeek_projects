...
my_label.pack() #pack() is a method that adds the label to the window. it's a packer that shows where the label appears on the window.
"""



if you want label to appear like a ticker, you can use the following code:
